namespace SKSMCorp.Host.Configuration;
...
public static class HostConfiguration
{
    ...
    /// </summary>
    public const string ConnectionSetting = "SKSMCORP_CONNECTION";

    /// <summary>
    /// Opts the OpenAPI document and the Scalar reference UI in
    /// (docs/architecture.md section 18). Absent means off.
    /// </summary>
    public const string ApiDocumentationSetting = "SKSMCORP_API_DOCUMENTATION";
    ...
    /// </summary>
    public const string TrustedProxiesSetting = "SKSMCORP_TRUSTED_PROXIES";
    ...
    /// </summary>
    public const string PublicBaseUrlSetting = "SKSMCORP_PUBLIC_BASE_URL";
    ...
    /// </summary>
    public const string MailSenderAddressSetting = "SKSMCORP_MAIL_SENDER_ADDRESS";

    public const string MailSenderNameSetting = "SKSMCORP_MAIL_SENDER_NAME";

    public const string MailServiceAccountSetting = "SKSMCORP_MAIL_SERVICE_ACCOUNT";
    ...
    /// </summary>
    public const string MailServiceAccountKeySetting = "SKSMCORP_MAIL_SERVICE_ACCOUNT_KEY";
    ...
    /// </summary>
    public const string MailDevSinkDirectorySetting = "SKSMCORP_MAIL_DEV_SINK_DIRECTORY";
}
