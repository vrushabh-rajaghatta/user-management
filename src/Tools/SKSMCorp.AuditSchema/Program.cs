...
namespace SKSMCorp.AuditSchema;
...
/// same dependency-isolation argument that keeps SKSMCorp.Provisioning
...
{
    internal const string ConnectionVariable = "SKSMCORP_PRIVILEGED_CONNECTION";
    ...
    private static void WriteUsage(TextWriter writer)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("  dotnet run --project src/Tools/SKSMCorp.AuditSchema");
        writer.WriteLine();
