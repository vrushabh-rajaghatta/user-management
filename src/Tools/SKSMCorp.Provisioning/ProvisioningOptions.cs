...
{
    internal const string ConnectionSetting = "SKSMCORP_CONNECTION";
    ...
    internal static string Usage =>
        $"""
         Provisions a migrated but unprovisioned SKSMCorp database: the platform
         baseline (PRV-C1) and the bootstrap administrator (PRV-C3).

         Usage:
           SKSMCorp.Provisioning
