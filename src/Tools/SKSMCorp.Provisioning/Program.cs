...
public static class Program
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var context = services.GetRequiredService<SKSMCorpDbContext>();
        ...
        var missingAuditScripts = await SKSMCorp.Platform.Persistence.Audit
