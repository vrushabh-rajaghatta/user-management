...
namespace SKSMCorp.Platform.Persistence.Audit;
...
/// SKSMCorp.AuditSchema succeeded because it ran earlier; it establishes the
...
internal static class AuditHandoverVerification
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            Refuse(
                ["the Audit schema is not deployed; run SKSMCorp.AuditSchema after the migrations"],
                "before seeding");
        }
