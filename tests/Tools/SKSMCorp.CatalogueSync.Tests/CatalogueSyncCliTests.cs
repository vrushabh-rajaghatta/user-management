...
public sealed class CatalogueSyncCliTests
{
    ...
    {
        var previous = Environment.GetEnvironmentVariable("SKSMCORP_CONNECTION");
        ...
        {
            Environment.SetEnvironmentVariable("SKSMCORP_CONNECTION", previous);
        }
    }
    ...
    private static async Task<Run> RunAsync(string? connectionString, params string[] args)
    {
        if (connectionString is not null)
            Environment.SetEnvironmentVariable("SKSMCORP_CONNECTION", connectionString);
