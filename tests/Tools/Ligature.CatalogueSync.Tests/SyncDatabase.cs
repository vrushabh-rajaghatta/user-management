...
internal sealed class SyncDatabase : IAsyncDisposable
{
    ...
    /// <summary>
    /// Captured ONCE, before any test points LIGATURE_CONNECTION at a throwaway
    ...
    private static readonly string RootConnection =
        Environment.GetEnvironmentVariable("LIGATURE_CONNECTION") ?? DefaultConnection;
    ...
    {
        var databaseName = $"ligature_sync_{Guid.NewGuid():N}";
