using SKSMCorp.Platform.Domain.Audit;
...
/// here: provisioning does not trust that SKSMCorp.AuditSchema ran; it
...
public sealed class AuditProvisioningTests
{
    ...
    /// <summary>
    /// Provisioning does not trust that SKSMCorp.AuditSchema ran because it
    ...
    public async Task A_tenant_without_the_audit_schema_is_not_handed_over()
    {
        ...
        Assert.Contains("SKSMCorp.AuditSchema", failure.Message);
